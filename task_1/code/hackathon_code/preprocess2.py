...
def prepare_data_test(group):
    ...
    return res
def preprocess_task_2(df_path: str, test: bool):
    """
    ...
    if test:
        ...
        X, y = grouped.drop("trip_id_unique", axis=1), grouped.trip_id_unique
        X.to_csv("test_to_model2.csv", index=False, encoding="ISO-8859-8")
        y.to_csv("label.csv", index=False, encoding="ISO-8859-8")
        return "test_to_model2.csv", "label.csv"
    else:
